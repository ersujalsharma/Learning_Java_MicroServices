...
public class DemoPrimaryKeyIdentityApplication implements CommandLineRunner {
	
	public static final Log LOGGER = LogFactory.getLog(DemoPrimaryKeyIdentityApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(DemoPrimaryKeyIdentityApplication.class,args);
	}
	...
	public void addCustomer() {
		...
		customerDTO.setEmailId("tim@sujal.com");
