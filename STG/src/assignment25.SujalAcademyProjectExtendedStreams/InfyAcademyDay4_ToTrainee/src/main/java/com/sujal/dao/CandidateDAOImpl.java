...
public class CandidateDAOImpl implements CandidateDAO {
    //Observe the return statement compare with InfyAcademyDay3_ToTrainee
	public String addCandidate(Candidate candidates) throws SujalAcademyException {
		return "INSERT_SUCCESS";
	}

	public List<CandidateReport> getAllCandidates() throws SujalAcademyException {
