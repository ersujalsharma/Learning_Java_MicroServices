...
//		deleteCustomerByEmailId();
	...
	public void findNameByEmailId() {
		try {
			String name = customerService.findNameByEmailId("john@sujal.com");
	...
	public void updateCustomerByEmailId() {
		...
		try {
			customerService.updateCustomerEmailId("martin02@sujal.com", 1);
	...
	public void deleteCustomerByEmailId() {
		...
		try {
			customerService.deleteCustomerByEmailId("martin02@sujal.com");
